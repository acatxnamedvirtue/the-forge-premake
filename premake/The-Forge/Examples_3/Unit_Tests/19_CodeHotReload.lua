project "19_CodeHotReload_Main"
    ...
    files
    {
        "%{Examples_3}/Unit_Tests/src/19_CodeHotReload/%{prj.name}.cpp",
        "%{Examples_3}/Unit_Tests/src/19_CodeHotReload/IGamePlugin.h",
        "%{Common_3}/Game/ThirdParty/OpenSource/flecs/flecs.c",
        "%{Common_3}/Game/ThirdParty/OpenSource/flecs/flecs.h",
    }
    ...
    fsl_includes
    {
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/19_CodeHotReload/Shaders/FSL/basic.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/19_CodeHotReload/Shaders/FSL/basic.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/19_CodeHotReload/Shaders/FSL/ShaderList.fsl',
    }
    
    postbuildcommands
    {
        '{MKDIR}    "%{cfg.targetdir}/Textures"',
        '{COPYFILE} "%{Examples_3}/Unit_Tests/UnitTestResources/Textures/sprites.dds" "%{cfg.targetdir}/Textures"',
...
project "19a_CodeHotReload_Game"
    kind "SharedLib"
    language "C++"
    cppdialect "C++14"
    staticruntime "off"
    ...
    files
    {
       "%{Examples_3}/Unit_Tests/src/19_CodeHotReload/19_CodeHotReload_Game.cpp",
    }
...
links
{
    ...
    postbuildcommands
    {
        ...
        '{COPYFILE} "%{Common_3}/OS/ThirdParty/OpenSource/winpixeventruntime/bin/WinPixEventRuntime.dll" "%{cfg.targetdir}"',
        '{COPYFILE} "%{Common_3}/Graphics/ThirdParty/OpenSource/ags/ags_lib/lib/amd_ags_x64.dll" "%{cfg.targetdir}"',
        '{COPYFILE} "%{cfg.targetdir}/%{prj.name}.dll" "%{cfg.targetdir}/../19_CodeHotReload_Main"',
    }
