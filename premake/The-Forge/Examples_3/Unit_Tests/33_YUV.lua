project "33_YUV"
    ...
    fsl_includes
    {
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/33_YUV/Shaders/FSL/basic.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/33_YUV/Shaders/FSL/basic.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/33_YUV/Shaders/FSL/ShaderList.fsl',
    }
    
    postbuildcommands
    {
        '{MKDIR}    "%{cfg.targetdir}/Textures"',
        '{COPYFILE} "%{Examples_3}/Unit_Tests/UnitTestResources/Textures/test_224x116_IYUV.dds" "%{cfg.targetdir}/Textures"',
