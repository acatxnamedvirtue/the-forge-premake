project "21_Animations"
    ...
    fsl_includes
    {
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/21_Animations/Shaders/FSL/basic.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/21_Animations/Shaders/FSL/basic.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/21_Animations/Shaders/FSL/plane.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/21_Animations/Shaders/FSL/plane.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/21_Animations/Shaders/FSL/ShaderList.fsl',
    }
    ...
    postbuildcommands
    {
        ...
        '{COPYDIR}  "%{cfg.targetdir}/../OS/Shaders/DIRECT3D11" "%{cfg.targetdir}/Shaders/DIRECT3D11"',
