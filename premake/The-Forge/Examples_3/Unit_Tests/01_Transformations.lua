project "01_Transformations"
    ...
    fsl_includes
    {
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/basic.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/basic.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/crash.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/resources.h.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/ShaderList.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/skybox.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/01_Transformations/Shaders/FSL/skybox.vert.fsl',
    }
