project "14_WaveIntrinsics"
    ...
    fsl_includes
    {
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/14_WaveIntrinsics/Shaders/FSL/magnify.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/14_WaveIntrinsics/Shaders/FSL/magnify.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/14_WaveIntrinsics/Shaders/FSL/resources.h.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/14_WaveIntrinsics/Shaders/FSL/ShaderList.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/14_WaveIntrinsics/Shaders/FSL/wave.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/14_WaveIntrinsics/Shaders/FSL/wave.vert.fsl',
    }
