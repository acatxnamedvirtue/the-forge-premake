project "35_VariableRateShading"
    kind "ConsoleApp"
    language "C++"
    cppdialect "C++14"
    staticruntime "off"
    ...
    fsl_includes
    {
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/35_VariableRateShading/Shaders/FSL/basic.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/35_VariableRateShading/Shaders/FSL/basic.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/35_VariableRateShading/Shaders/FSL/compShadingRate.comp.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/35_VariableRateShading/Shaders/FSL/cube.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/35_VariableRateShading/Shaders/FSL/cube.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/35_VariableRateShading/Shaders/FSL/ShaderList.fsl',
    }
    
    postbuildcommands
    {
        '{COPYDIR}  "%{Examples_3}/Unit_Tests/UnitTestResources/Textures" "%{cfg.targetdir}/Textures"',
        '{COPYDIR}  "%{Art}/Sponza/Textures/SponzaPBR_Textures/Lion" "%{cfg.targetdir}/Textures"',
