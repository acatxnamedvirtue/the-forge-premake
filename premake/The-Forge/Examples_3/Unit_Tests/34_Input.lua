project "34_Input"
    ...
    files
    {
        ...
        "%{Examples_3}/Unit_Tests/src/%{prj.name}/ButtonDefs.h",
    }
    ...
    fsl_includes
    {
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/34_Input/Shaders/FSL/basic.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/34_Input/Shaders/FSL/basic.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/34_Input/Shaders/FSL/ShaderList.fsl',
    }
    
    postbuildcommands
    {
        '{COPYDIR}  "%{Examples_3}/Unit_Tests/UnitTestResources/Textures/input" "%{cfg.targetdir}/Textures"',
