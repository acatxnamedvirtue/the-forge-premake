project "37_PrecomputedVolumeDLUT"
    kind "ConsoleApp"
    language "C++"
    cppdialect "C++14"
    staticruntime "off"
    ...
    fsl_includes
    {
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/37_PrecomputedVolumeDLUT/Shaders/FSL/PrecomputedDLUT.frag.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/37_PrecomputedVolumeDLUT/Shaders/FSL/PrecomputedDLUT.vert.fsl',
        '$(SolutionDir)/The-Forge/Examples_3/Unit_Tests/src/37_PrecomputedVolumeDLUT/Shaders/FSL/ShaderList.fsl',
    ...
    postbuildcommands
    {
        ...
        '{COPYDIR}  "%{Examples_3}/Unit_Tests/UnitTestResources/Textures/DLUT" "%{cfg.targetdir}/Textures"',
